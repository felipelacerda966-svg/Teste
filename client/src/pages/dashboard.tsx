    ...
    <div className="mx-auto px-4 py-4 max-w-sm sm:max-w-md md:max-w-4xl lg:max-w-7xl">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            <div className="h-8 w-20 bg-gradient-to-r from-blue-600 to-orange-500 rounded flex items-center justify-center">
              <span className="text-white text-xs font-bold">AceleraFit</span>
            </div>
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold text-gray-900">AceleraFit</h1>
            </div>
          </div>
          <Button className="bg-primary text-white hover:bg-red-600 px-3 py-2 text-sm">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="text-gray-600 text-sm sm:text-base">Vamos continuar sua jornada fitness</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-6">
        <Card>
          <CardContent className="p-4 md:p-6">
            <div className="flex flex-col items-center md:flex-row md:items-start">
              <div className="bg-primary/10 p-2 md:p-3 rounded-lg mb-2 md:mb-0 md:mr-4">
                <Flame className="text-primary h-5 w-5 md:h-6 md:w-6" />
              </div>
        ...
        <Card>
          <CardContent className="p-4 md:p-6">
            <div className="flex flex-col items-center md:flex-row md:items-start">
              <div className="bg-accent/10 p-2 md:p-3 rounded-lg mb-2 md:mb-0 md:mr-4">
                <Trophy className="text-accent h-5 w-5 md:h-6 md:w-6" />
              </div>
              <div className="text-center md:text-left">
        ...
        <Card>
          <CardContent className="p-4 md:p-6">
            <div className="flex flex-col items-center md:flex-row md:items-start">
              <div className="bg-blue-100 p-2 md:p-3 rounded-lg mb-2 md:mb-0 md:mr-4">
                <Weight className="text-blue-600 h-5 w-5 md:h-6 md:w-6" />
              </div>
              <div className="text-center md:text-left">
        ...
        <Card>
          <CardContent className="p-4 md:p-6">
            <div className="flex flex-col items-center md:flex-row md:items-start">
              <div className="bg-purple-100 p-2 md:p-3 rounded-lg mb-2 md:mb-0 md:mr-4">
                <Star className="text-purple-600 h-5 w-5 md:h-6 md:w-6" />
              </div>
              <div className="text-center md:text-left">
